  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const savePromise = new Promise<void>(async (resolve, reject) => {
      try {
        ...
        reject('Failed to create language');
      } finally {
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Add Language</h1>
          <p className="text-muted-foreground">Add a new language to your profile</p>
        </div>
        <Link
